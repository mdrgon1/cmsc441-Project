...
const int N = 8;
const int OPTIMAL_K = 64;

void test_time_usage() {
    int bam_samples[] = { 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024 };
    int samk_samples[] = { 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024 };
    int sam_samples[] = { 2, 4, 8, 16, 32, 64, 128, 256, 512 };
    int k_samples[] = { 8, 16, 32, 64, 128, 256, 512 };
    //int k_samples[] = { 256 };
    ...
    //float* mean_speedup = new float[7];
    //float* std_dev_speedup = new float[7];
    //speedup_foreach_k(k_samples, 7, 512, mean_speedup, std_dev_speedup);
